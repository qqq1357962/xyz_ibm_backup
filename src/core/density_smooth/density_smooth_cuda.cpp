...
//         node_pos, node_size, node_weight, aux_mat, unit_len, num_bin_x, num_bin_y, num_nodes);
// }
...
//         node_pos, node_size, grad_mat, unit_len, node_grad, num_bin_x, num_bin_y, num_nodes);
// }
...
torch::Tensor density_smooth_forward(torch::Tensor normalize_node_info,
    ...
    return density_smooth_cuda_forward(
        normalize_node_info, sorted_node_map, aux_mat, num_bin_x, num_bin_y, num_nodes);
}
